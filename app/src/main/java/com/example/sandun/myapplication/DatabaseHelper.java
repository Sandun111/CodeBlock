...
public class DatabaseHelper {
    ...
    public  void deleteCode(String codeId)
    {
        ...
        db.delete(myDbHelper.TABLE_CODE ,myDbHelper.ID+" = ?",whereArgs);
    }
...
*/
    ...
    public long insertNumber(String number, String time)
    {
    ...
    {
        SQLiteDatabase db = myhelper.getWritableDatabase();
        String[] columns = {myDbHelper.ID,myDbHelper.NUMBER,myDbHelper.TIME};
    ...
    static class myDbHelper extends SQLiteOpenHelper
    {
        ...
        private static final String CREATE_TABLE_NUMBER = "CREATE TABLE "+TABLE_NUMBER+
                " ("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NUMBER+" VARCHAR(255) ,"+ TIME+" VARCHAR(225));";
